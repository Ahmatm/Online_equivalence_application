...
<head>
    ...
    <title>Login | Online Equivalence Application System</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: blue">Online Equivalence Application</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <center><b><h3 style="color: grey">User Login Form</h3></b></center>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <p style="text-align: center;"><a href="../admin/login.php">Admin Panel</a></p>
                                    </div>
                                </div>
                            </div>
                        </form>
