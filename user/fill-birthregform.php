...
$query->bindParam(':email',$email,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Equivalence detail has been added.")</script>';
...
<head>
    ...
    <title>Equivalency Certificate Form | Online Equivalence Application System</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Equivalence Registration Form</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Date of starting university</label>
                                                                </div>
                                                                <div class="col-lg-9">
