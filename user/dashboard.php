                            ...
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-title">
                                    <div class="main-income-head">
                                        <h2>Total</h2>
                                        <div class="main-income-phara">
                                        <a href="fill-birthregform.php">
                                          
                                  <p>New Application</p></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range">
                                        ...
                                        <a class="block text-center" href="view-birthregform.php"><strong style="color:white">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                            ...
                            <div class="income-dashone-total orders-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range order-cl">
                                        <a class="block text-center" href="#"><strong style="color:white">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                            ...
                            <div class="income-dashone-total visitor-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range visitor-cl">
                                        <a class="block text-center" href="certificates-list.php"><strong style="color:white">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
