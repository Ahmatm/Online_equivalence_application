...
{               ?>
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-envelope"></i> <span class="mini-dn">Application Reg Form</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                        ...
                        <li class="nav-item">
                            <a href="document.php" role="button" aria-expanded="false"><i class="fa big-icon fa-file-pdf-o"></i> <span class="mini-dn">Upload Document</span></a>
                        </li>

                        <li class="nav-item">
                            <a href="payment.php" role="button" aria-expanded="false"><i class="fa big-icon fa-credit-card"></i> <span class="mini-dn">Payment</span></a>
                        </li>
